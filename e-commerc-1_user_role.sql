...
CREATE TABLE `user_role` (
  ...
  CONSTRAINT `user_role_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `user_role` VALUES (1,1),(2,2),(3,3),(1,1),(2,2),(3,3),(4,3);
